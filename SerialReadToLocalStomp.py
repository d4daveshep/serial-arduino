...
stomp = Connection([('localhost', 61613)],auto_content_length=False) # auto_content_length=False sets the message type to TextMessage
...
#    print(line.decode('utf-8'))
    ...
    data['timestamp'] = stamp.strftime('%Y-%m-%d %H:%M:%S.0')
